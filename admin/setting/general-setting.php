...
?>
        ...
        public function ppws_whole_site_register_settings_init()
        {
            ...
            add_settings_field(
                ...
                'ppws-password-settings-section',
                'ppws_password_settings_section',
                ['type' => 'checkbox', 'label_for' => 'ppws_enable_password_field_checkbox', 'description' => 'Enable password for whole site.','custom_class' => 'ppws_password_checkbox_validation']
            );
            ...
            add_settings_field(
                ...
                [
                    ...
                    'description' => 'Set password for whole site.',
                    'class' => "$ppws_whole_site_enable_password_class ppws-whole-site-password-section"
                ]
            );
            ...
            add_settings_field(
                ...
                [
                    ...
                    'description' => 'Set expiry time of password for whole site.',
                    'class' => "$ppws_whole_site_enable_password_class ppws-whole-site-password-section"
                ]
            );
            ...
            add_settings_field(
                ...
                'ppws-user-role-section',
                'ppws_user_role_settings_section',
                ['type' => 'checkbox', 'label_for' => 'enable_user_role', 'description' => 'Enable to set user wise password for whole site. <br>

                When user role is disable then password apply for both loggedin user and non logged in user.']
            );
        ...
        public function ppws_password_settings($args)
        {
            ...
            ?>
                <!-- Numberbox -->
                <input type="number" class="ppws-numberbox" min="1" max="400" name="ppws_general_settings[<?php esc_attr_e($args['label_for']); ?>]" id="<?php esc_attr_e($args['label_for']) ?>" value="<?php esc_attr_e($value) ?>" placeholder="<?php esc_attr_e($args['placeholder']) ?>">
                <p class="ppws-note"><?php esc_attr_e($args['description'],'password-protected-store-for-woocommerce') ?></p>
            <?php
            }
        }
        ...
        public function sanitize_settings($input)
        {
           ...
           if (isset($input['ppws_set_password_field_textbox']) && !empty($input['ppws_set_password_field_textbox'])) {
            ...
            if (isset($input['ppws_set_password_expiry_field_textbox']) && !empty($input['ppws_set_password_expiry_field_textbox'])) {
                ...
                $new_input[ 'ppws_set_password_expiry_field_textbox' ] = 1;
            }
