...
?>
        ...
        public function ppws_page_register_settings_init()
        {
            ...
            add_settings_field(
                ...
                'ppws-page-password-settings-section',
                'ppws_page_password_settings_section',
                ['type' => 'checkbox', 'label_for' => 'ppws_page_list_of_page_field_checkbox', 'description' => 'Selected pages are protected with password.','class' => "$ppws_page_enable_password_class ppws-page-enable-password-section"]
            );
            ...
            add_settings_field(
                ...
                'ppws-page-user-role-section',
                'ppws_page_user_role_settings_section',
                ['type' => 'radio', 'label_for' => 'ppws_page_select_user_role_field_radio', 'description' => 'Enable to set user wise password for pages.<br> When user role is disable then password apply for both loggedin user and non logged in user']
            );
