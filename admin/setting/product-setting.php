    ...
    class ppws_product_settings
    {
        ...
        function ppws_product_callback()
        {
            ...
            <form action="options.php?tab=product-setting" method="post" class="ppws-product-setting-form">
                ...
                echo _e('The "product" password will be applied to selected products. If both the "product" and "General" passwords are enabled, then the "General" password will not be applicable to the selected products in the product settings.','password-protected-store-for-woocommerce');
                echo '</p>';
                ?>
                ...
                <div class="ppws_all_user_list">
                    ...
                    foreach ($editable_roles as $role) {
                        ...
                        <div class="ppws_all_user_list_input">
                            <label>
                                <input type="checkbox" class="ppws-checkbox editable_roles_single" name="ppws_product_settings[<?php esc_attr_e($args['label_for']) ?>][]" value="<?php esc_attr_e($role['name']); ?>" <?php if (is_array($value)) { if (in_array($role['name'], $value)) { esc_attr_e('checked'); } } ?>>
        ...
        public function ppws_product_select_user_role_settings($args)
        {
            ...
            if ($args['type'] == 'radio') {
            ?>
                <label class="ppws-label"><input type="radio" class="<?php esc_attr_e('ppws_user_non_logged_in_user'); ?>" name="ppws_product_settings[<?php esc_attr_e($args['label_for']); ?>]" value="non-logged-in-user" <?php checked('non-logged-in-user', $ppws_product_options[$args['label_for']] ?? 'non-logged-in-user'); ?>><?php _e('Non Logged In User', 'password-protected-store-for-woocommerce') ?></label>

                <label class="ppws-label"> <input type="radio" class="<?php esc_attr_e('ppws_user_logged_in_user'); ?>" name="ppws_product_settings[<?php esc_attr_e($args['label_for']); ?>]" value="logged-in-user" <?php checked('logged-in-user', $ppws_product_options[$args['label_for']] ?? null); ?>><?php _e('Logged In User', 'password-protected-store-for-woocommerce') ?></label>
