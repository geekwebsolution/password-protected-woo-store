...
This is a great plugin for securing your WooCommerce store. It enables you to easily set passwords for accessing your store.
...
🔹 Option to manage REST API data protection with protect settings
...
🔹 Hide protected single category products from product loop.
🔹 Protect specific category archive page.
🔹 Set a password to specific product.
🔹 Set product password for specific user types and user roles.
🔹 Users have the option to access products with different category password.
...
= 2.6.1 =
 Fixed Custom CSS field decode special character
...
= 2.5.6 =
  Fixed protected product visibility bugs.
...
= 2.2 =
- Translate string bug fixed

= 2.1 =
- Hide protected products from search results.
